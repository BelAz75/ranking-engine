...
public class ModelMapper implements Mapper{
    ...
    public PageObject<Media> mapMedias(InputStream jsonStream){
        GraphQlResponse<PageObject<Media>> medias = mapObject(jsonStream, "medias.json");
    ...
    public Media mapMedia(InputStream jsonStream){
        ...
        if(media.getCommentPreview()!=null) {
            ...
            if (media.getCommentPreview().getNodes() != null) {
    ...
    public PageObject<Comment> mapComments(InputStream jsonStream){
        GraphQlResponse<PageObject<Comment>> comments = mapObject(jsonStream, "comments.json");
    ...
    public Location mapLocation(InputStream jsonStream){
        GraphQlResponse<Location> graphQlResponse = mapObject(jsonStream, "location.json");
    ...
    public Tag mapTag(InputStream jsonStream){
        GraphQlResponse<Tag> graphQlResponse = mapObject(jsonStream, "tag.json");
    ...
    public PageObject<Account> mapFollow(InputStream jsonStream){
        GraphQlResponse<PageObject<Account>> follow = mapObject(jsonStream, "follow.json");
        return follow.getPayload();
    }

    public PageObject<Account> mapFollowers(InputStream jsonStream) {
        GraphQlResponse<PageObject<Account>> followers = mapObject(jsonStream, "followers.json");
    ...
    public ActionResponse<Comment> mapMediaCommentResponse(InputStream jsonStream) {
        ActionResponse<Comment> commentActionResponse = mapObject(jsonStream, "mediaCommentResponse.json", ActionResponse.class);
    ...
    public PageObject<Account> mapLikes(InputStream jsonStream) {
        GraphQlResponse<PageObject<Account>> likesResponse = mapObject(jsonStream, "mediaLikes.json");
        return likesResponse.getPayload();
    }

    public ActivityFeed mapActivity(InputStream jsonStream) {
        GraphQlResponse<ActivityFeed> activityFeed = mapObject(jsonStream, "activity.json");
    ...
    public Account mapAccount(InputStream jsonStream) {
        GraphQlResponse<Account> graphQlResponse = mapObject(jsonStream, "account-binding.json", GraphQlResponse.class);
